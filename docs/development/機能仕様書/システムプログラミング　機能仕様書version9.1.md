...
④ 紐付けが完了することで、ユーザーが人数選択を可能な状態となる。<br>
※ 毎日初めてのお客さんが来店する前と、それぞれの決済後テーブルを清掃を行う際に設定するものとする。
* 管理者認証機能：管理者は、入力した管理者名とパスワードを事前にシステム内で定めた固定値と照合され認証されると、テーブル番号と該当端末の紐付けを行うことができる。<br>
    * 管理者名：固定値
    * パスワード：固定値
* テーブル番号紐付け機能: 入力された4桁の数字（0000から9999）をテーブル番号として端末に設定する。
    * テーブル番号：４桁の数字（0000から9999）
    * ※運用上のルールとして、管理者は重複しない番号を入力するものとする。
    * ※万が一、既存のテーブル番号と同じ番号が入力された場合、エラーにはせず、同一のテーブルとして動作する。
...
* 注文数カウント機能：注文された情報を基に、それぞれの客層がどの商品をどれくらい頼んだか記録する。
...
> 状態<br>
・アクティブ：ユーザーがログイン可能な状態<br>
・ロックアウト：ユーザーがログインできない状態
...
* ランキング表示機能：管理者は、客層ごとに7日前（168時間前）からの売上トップ5の商品を閲覧することができる。
    ...
    * 客層<br>・**大人1人**：大人1人<br>・**大人2人**：大人2人<br>・**ファミリー**：大人1から2人 ＋ 子供1から7人<br>・**大人グループ**：大人3から8人<br>・**グループ**：大人3から7人 ＋ 子供1から5人
